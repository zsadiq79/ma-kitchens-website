...
function WhatsAppOrderButton() {
  return (
    <a
      className="inline-flex min-h-12 items-center justify-center gap-2.5 rounded-full bg-clay px-7 py-3 text-center text-xs font-bold uppercase tracking-[0.18em] text-white transition hover:bg-ink focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-clay sm:px-8"
