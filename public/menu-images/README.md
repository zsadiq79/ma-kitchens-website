...
- Supported MVP formats are `.jpg`, `.jpeg`, and `.webp`; JPEG is acceptable and WebP is not required.
- `.jpg` and `.jpeg` are both valid filename extensions for JPEG images.
- Example filenames: `DISH-001.jpg`, `DISH-002.jpeg`, and `DISH-003.webp`.
- Example public URLs:
  - `https://www.makitchens.com.au/menu-images/DISH-001.jpg`
  - `https://www.makitchens.com.au/menu-images/DISH-002.jpeg`
  - `https://www.makitchens.com.au/menu-images/DISH-003.webp`
